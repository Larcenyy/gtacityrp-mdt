...
import TabletteContent from "./components/view/lapd_dac/lapd-content";
import React from "react";

import PageMDT from "./components/view/lapd_dac/pages/mdt/lapd-page-mdt";
    ...
    return (
        ...
        <div className="App">
            <Routes>
                ...
                <Route path="/mdt" element={<TabletLayout> <TabletteContent> <PageMDT/> </TabletteContent> </TabletLayout>} />
            </Routes>
        </div>
    );
}
